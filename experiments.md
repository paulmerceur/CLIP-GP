...
**test_5** — k=128, PREC=fp16, GP(kernel=rbf, mc=20, lr=0.01, β=1), SGD(lr=0.01, cosine, 200 epochs, momentum=0.9, warmup=10), batch=128x128, 7 templates
**test_6** — k=128, PREC=fp16, GP(kernel=rbf, mc=20, lr=0.01, β=1, learnable inducing points), SGD(lr=0.01, cosine, 200 epochs, momentum=0.9, warmup=10), batch=128x128, 7 templates
